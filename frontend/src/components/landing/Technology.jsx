...
const Technology = () => {
    return (
        <Section id="tech" className="bg-[var(--soft-surface)]">
            <div className="wrap">
                <h2 className="title-lg mb-4 text-center text-[24px] font-extrabold tracking-[-.02em] text-ink md:text-[36px]">
                ...
                <div className="text-center mb-10">
                    <div className="inline-flex gap-12 flex-wrap justify-center p-6 bg-[rgba(31,199,182,0.1)] rounded-xl border-2 border-teal mb-5">
                        <div>
                            ...
                            <div className="mt-1 text-sm font-semibold text-muted">Patent Claims Filed</div>
                        </div>
                        <div>
                            <div className="text-[32px] md:text-[48px] font-black text-teal leading-none">2,000+</div>
                            <div className="mt-1 text-sm font-semibold text-muted">Platform Screens Designed</div>
                        </div>
                    </div>
                    <p className="body-text italic text-muted">
